...
NeuroneNetwork();
NeuroneNetwork(std::vector<Neurone*>& neurons, double lambda, double L); //pour construire un réseau de neurones à partir d'un vec
~NeuroneNetwork();
...
Neurone& getNeuron(int id); //récupère un neurone avec un id donné
